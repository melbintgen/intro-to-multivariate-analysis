...
1. Interpretation of the sample plot. What do we notice regarding the amount of explained variance per component, compared to PCA. Is this expected? Let's also the sample plot for components 1 vs. 3.
...
2. Plot a sample plot for components 1. vs 3, what do you observe? Also plot the loadings for component 3 for more insights.
...
2. Sample plot of comp 1 vs comp 3 shows a clearer separation of `r colorize("grey", "NB")` vs. `r colorize("green", "RMS")` compared to COmp 1 vs Comp 3. This is also reflected in the loading plot on component 3.
